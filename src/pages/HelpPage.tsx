...
import { ChevronDown, HelpCircle, Lightbulb, BookOpen, Settings, BarChart } from "lucide-react"
import "./HelpPage.css"
type HelpPageProps = {}
...
const HelpPage: React.FC<HelpPageProps> = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "בדף הראשי יש פאנל שמציג את התקדמותך, כולל סטטיסטיקות על התרגילים שביצעת, ציונים והמלצות לנושאים לשיפור.",
      icon: <BarChart className="h-5 w-5" />,
    },
    {
      question: "איך אני מוסיף נושאים חדשים ללימוד?",
      answer: "באזור הניהול של המשתמש תוכל לבחור נושאים חדשים ללימוד מתוך קטלוג הנושאים המוצעים על ידי המערכת.",
      icon: <BookOpen className="h-5 w-5" />,
    },
    {
      question: "מה קורה אם אני רוצה לשנות את רמת הקושי של השיעורים?",
      answer: "ניתן לשנות את רמת הקושי של השיעורים בהגדרות הפרופיל שלך, תחת האפשרות 'הגדרות לימוד'.",
      ...
      <div className="help-page">
        ...
        <div className="help-footer">
          <div className="help-character">
            <img src="/BotPic.png" alt="Helper character" className="character-image" />
