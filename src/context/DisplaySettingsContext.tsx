...
//   highContrast: boolean;
//   primaryColor: string;
//   theme: Theme; // Add theme to the interface
//   setFontSize: (n: number) => void;
//   setLineHeight: (n: number) => void;
//   setFormulaFontSize: (n: number) => void;
//   setHighContrast: (c: boolean) => void;
//   setPrimaryColor: (c: string) => void;
//   setTheme: (t: Theme) => void; // Add setTheme to the interface
//   toggleTheme: () => void; // Add toggleTheme for convenience
// }
...
//     () => localStorage.getItem("ds.primaryColor") || "#6A4CFF"
//   );
//   const [theme, setTheme] = useState<Theme>( // New state for theme
