...
import "./PersonalInfo.css"; // Import the new CSS file
  ...
  return (
    <div className="personal-info-container">
      ...
      <div className="profile-header">
        {/* Profile image moved to side */}
        <div className="profile-image-upload-area" onClick={triggerImageUpload}>
          <img
        ...
        <div className="profile-header-text">
          <h2 className="profile-title">פרופיל אישי</h2>
          <p className="profile-subtitle">עדכן את הפרטים האישיים שלך</p>
        </div>
      </div>
      ...
      <div className="profile-form-grid">
        ...
        <div className="my-details-section">
          <h3 className="section-title section-title-indigo">
            <span className="section-icon section-icon-indigo">👤</span>
            הפרטים שלי
          </h3>
          <div className="input-group-container">
            <div className="input-group">
              <label className="input-label input-label-indigo">
                🏷️ שם מלא
              </label>
              <input
                type="text"
                ...
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="text-input input-indigo"
              />
            </div>
            <div className="input-group">
              <label className="input-label input-label-indigo">📧 מייל</label>
            ...
            <div className="input-group">
              <label className="input-label input-label-indigo">🎓 כיתה</label>
              <div className="select-wrapper">
                <select
                  value={className}
                  onChange={(e) => setClassName(e.target.value)}
                  className="select-input input-indigo"
                >
                  <option value="">בחר כיתה</option>
                  {gradeOptions.map((g) => (
                    <option key={g} value={g}>
                ...
                <div className="select-arrow">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 011.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 0 1 0-1.414z"
                      clipRule="evenodd"
                    ></path>
                  </svg>
                </div>
        ...
        <div className="parent-details-section">
          <h3 className="section-title section-title-purple">
            <span className="section-icon section-icon-purple">👨‍👩‍👧‍👦</span>
            פרטי ההורים
          </h3>
          <div className="input-group-container">
            <div className="input-group">
              <label className="input-label input-label-purple">
                👤 שם הורה
              </label>
              <input
                type="text"
                ...
                value={parentName}
                onChange={(e) => setParentName(e.target.value)}
                className="text-input input-purple"
              />
            </div>
            <div className="input-group">
              <label className="input-label input-label-purple">
              ...
              <input
                ...
                value={parentEmail}
                onChange={(e) => setParentEmail(e.target.value)}
                className="text-input input-purple email-parent-input"
                dir="ltr"
              />
            </div>
            <div className="input-group">
              ...
              <div className="phone-input-wrapper">
                <input
                  type="tel"
                  className="text-input input-purple phone-number-input"
                  placeholder="1234567"
                  value={phoneNumber}
                  onChange={(e) => setPhoneNumber(e.target.value)}
                  dir="ltr"
                ...
                <div className="select-wrapper phone-prefix-select-wrapper">
                  <select
                    className="select-input input-purple phone-prefix-select"
                    value={phonePrefix}
                    onChange={(e) => setPhonePrefix(e.target.value)}
                    dir="ltr"
                  >
                  ...
                  <div className="select-arrow phone-prefix-arrow">
                    <svg
                      className="select-arrow-icon"
                      fill="currentColor"
                      viewBox="0 0 20 20"
